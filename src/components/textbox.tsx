...
export default function Textbox({ sendMessage, messageInput, setMessage }: TextboxProps)  {
  ...
  return (
    <div className="flex flex-row justify-between bg-[#73a89faf] rounded-3xl px-2 py-1 w-[95%]  md:w-[80%] lg:w-[70%] ">
      ...
      <Avatar className="bg-[#32b89f] hover:cursor-pointer" onClick={sendMessage}>
